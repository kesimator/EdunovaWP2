...
export default function PredavaciPromijeni() {
  ...
  async function promijeniPredavac(predavac) {
    const odgovor = await PredavacService.promijeni(routeParams.sifra, predavac);
